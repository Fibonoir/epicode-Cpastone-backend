...
public class InsertionDTO {
    ...
    // This field is generally null for creation requests but returned in responses.
    private Long id;
    ...
    // For read-only purposes: the date the insertion was listed
    private Date dateListed;

    // Insertion status (for example: ACTIVE, PENDING, etc.)
